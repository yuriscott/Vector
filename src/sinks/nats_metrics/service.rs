...
use super::{config::NatsPublisher, request_builder::NatsMetricsRequest, NatsError};
...
impl Service<NatsMetricsRequest> for NatsService {
    ...
    fn call(&mut self, req: NatsMetricsRequest) -> Self::Future {
