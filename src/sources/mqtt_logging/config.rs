...
#[configurable_component(source("mqtt_logging", "Collect logs from MQTT."))]
...
#[typetag::serde(name = "mqtt_logging")]
impl SourceConfig for MqttSourceConfig {
    async fn build(&self, cx: SourceContext) -> crate::Result<crate::sources::Source> {
        ...
        let sink = MqttSource::new(connectors, decoder, log_namespace)?;
